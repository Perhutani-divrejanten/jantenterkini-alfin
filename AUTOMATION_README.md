...
- **email**: Email portal (akan replace "jantenterkini33@gmail.com")
- **socialHandle**: Handle social media (akan replace "jantenterkini")
- **colors**: Tema warna
  - **primary**: Warna utama kuning (contoh: #1F2937 → custom)
  - **dark**: Warna gelap hitam (contoh: #111827 → custom)
...
| `jantenterkini` | `siteName` (tanpa spaces) |
| `jantenterkini` | `socialHandle` |
| `jantenterkini33@gmail.com` | `email` |
| `#1F2937` (primary) | Warna primary dari config |
| `#111827` (dark) | Warna dark dari config |
